...
function CustomTimer() {
  ...
  return (
    <div className="rounded-2xl bg-white/5 backdrop-blur-xl border border-white/5 p-6 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10">

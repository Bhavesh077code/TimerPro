        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Welcome to TimerPro. We respect your privacy and are committed to protecting your personal data. 
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
            ...
            <ul className="text-gray-300 space-y-2 list-disc pl-6">
              ...
              <li>Local storage data (timers you create)</li>
            </ul>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-purple-400 mt-2">📧forgetemail057@gmail.com</p>
          </div>
